...
const ProductCard=()=>{
    return(<>
        <div
    className="md:max-w-[25%] rounded-xl
    ...
    <p className="text-center from-neutral-500">Product description in few words</p>
    </div>
    <div className=" flex justify-between w-[40%] mt-2 text-center">
    <h1 className="flex justify-between px-3 py-1 bg-green-600 w-[40%] rounded-md text-white font-bold">4 
    <svg
...
<h1 className="font-bold text-green-600">65% off</h1>
    ...
    <button className="bg-blue-500 p-3 px-5 rounded-xl font-semibold hover:bg-blue-700 hover:text-white">Add to Cart</button>
    </div>
    </div>
        </>)
}
